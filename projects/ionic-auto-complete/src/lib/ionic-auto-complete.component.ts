...
@Component({
    ...
    selector: 'ionic-auto-complete',
    styleUrls: [
        './ionic-auto-complete.component.scss'
    ],
    templateUrl: 'ionic-auto-complete.component.html',
    standalone: false
})
export class IonicAutoCompleteComponent implements OnInit, AfterViewChecked, ControlValueAccessor, DoCheck {
    public autocompleteOptions: IonicAutoCompleteOptions = new IonicAutoCompleteOptions();
    public defaultOpts!: IonicAutoCompleteOptions;
    public hasFocus: boolean = false;
    public isLoading: boolean = false;
    public focusedOption: number = -1;
    public formValue: any;
    public promise: any = null;
    ...
    @Input() public maxSelected: number | null = null;
    @Input() public multi: boolean = false;
    @Input() public name: string = '';
    @Input() public provider!: IonicAutoCompleteService | Function;
    ...
    @Input() public styles = new IonicAutoCompleteStyles;
    ...
    public keywordControl: FormControl = new FormControl();
    ...
    set options(options: IonicAutoCompleteOptions | any) {
        ...
        for (let i = 0; i < keysLength; i++) {
            ...
            if (typeof options[key] !== 'undefined') {
                (this.autocompleteOptions as any)[key] = options[key];
            }
        }
     ...
     * @private
     */
    private _getPosition(el: any): any {
        let xPos = 0;
        let yPos = 0;
     ...
     * @param show
     */
    public getItems(event?: any, show?: boolean): void {
        this.isLoading = true;
     ...
     * @param event
     */
    public handleTabOut(event: any): void {
     ...
     * @param event
     */
    public handleTap(event: any): void {
     ...
     * @param suggestion
     */
    public handleSelectTap($event: any, suggestion?: any): false {
